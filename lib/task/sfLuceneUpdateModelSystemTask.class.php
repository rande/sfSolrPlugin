...
EOF;
  ...
  public function update($app, $index, $culture, $model, $options)
  {
    ...
    do
    {
      ...
      catch(Exception $e)
      {
        ...
        {
          $this->logSection('lucene', '  memory limit reached, starting new subprocess');
  ...
  public function analyseLine($bytes)
  {
    $this->buffer .= str_replace("\r", "", $bytes);
