...
$t->ok($response instanceof Apache_Solr_Response, '::search returns Apache_Solr_Response object');
...
$t->ok($response->response->docs[0] instanceof Apache_Solr_Document, '->response->docs[0] return an instance Apache_Solr_Document');
